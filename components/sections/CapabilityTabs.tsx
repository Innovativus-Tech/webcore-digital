...
export function CapabilityTabs() {
  ...
  const tab = capabilities.tabs.find((t) => t.id === active)!;

  return (
    <section className="container-x py-20 md:py-28">
      <div className="max-w-2xl">
        <span className="eyebrow">Capabilities</span>
        <h2 className="mt-4 text-3xl md:text-4xl lg:text-[44px] lg:leading-tight">{capabilities.title}</h2>
        <p className="mt-4 text-ink-500">{capabilities.subtitle}</p>
      </div>
          ...
          <div className="col-span-5">
            <div className="rounded-card border border-ink-100 bg-gradient-to-br from-brand-50 to-white p-6 h-full min-h-[260px] grid place-items-center">
              <div className="text-center">
                ...
                <div className="mt-3 text-3xl font-semibold text-brand-900">{tab.bullets.length} core capabilities</div>
